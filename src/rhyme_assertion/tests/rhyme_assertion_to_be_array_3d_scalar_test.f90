logical function rhyme_assertion_to_be_array_3d_scalar_test() result(failed)
   use rhyme_assertion
   ...
   integer :: int_arr(5, 4, 3)
   real(kind=4) :: real_arr(5, 4, 3)
   real(kind=8) :: double_arr(5, 4, 3)
   character(len=32) :: char_arr(5, 4, 3)
   logical :: log_arr(5, 4, 3)
   ...
   if (failed) return
end function rhyme_assertion_to_be_array_3d_scalar_test
