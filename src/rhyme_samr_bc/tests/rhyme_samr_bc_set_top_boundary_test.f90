...
#define KDX ,1:d(3)
   ...
   bc%cons_inflows(cid%rho, bcid%top) = 1.23d0
   bc%cons_inflows(cid%rho_u:cid%rho_u + NDIM - 1, bcid%top) = 2.34d0
   bc%cons_inflows(cid%e_tot, bcid%top) = 3.45d0
   bc%cons_inflows(cid%e_tot + 1:NCMP, bcid%top) = 4.56d0
