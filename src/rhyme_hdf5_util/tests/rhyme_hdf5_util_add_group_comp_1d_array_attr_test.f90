logical function rhyme_hdf5_util_add_group_comp_1d_array_attr_test () result ( failed )
  use rhyme_hdf5_util

  implicit none

  ! Constants
  character ( len=1024 ), parameter :: testfile = "./test_hdf5_util_add_group_comp_1d_array_attr.h5"
  ...
  call h5%add_group_comp_1d_array_attr ( "/", "int_attr", keys , array_i )
  call h5%add_group_comp_1d_array_attr ( "/", "real_attr", keys , array_r )
  call h5%add_group_comp_1d_array_attr ( "/", "real8_attr", keys , array_r8 )
  call h5%close
...
end function rhyme_hdf5_util_add_group_comp_1d_array_attr_test
