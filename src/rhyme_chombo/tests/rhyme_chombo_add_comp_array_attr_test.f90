logical function rhyme_chombo_add_comp_array_attr_test () result ( failed )
  ...
  character(len=256), parameter :: testfile = "./test_chombo_file_add_comp_array_attr.h5"
  ...
  call ch%add_comp_array_attr ( "/", "int_attr", keys , array_i )
  call ch%add_comp_array_attr ( "/", "real_attr", keys , array_r )
  call ch%add_comp_array_attr ( "/", "real8_attr", keys , array_r8 )
  call ch%close
...
contains
  subroutine read_comp_array_attr ( type_id, attr_name, buf )
    ...
    call h5aopen_f ( file_id, trim(attr_name), attr_id, hdferr )
...
end function rhyme_chombo_add_comp_array_attr_test
