logical function rhyme_report_plot_histograms_test() result(failed)
   ...
   report = report_factory_generate('histograms')
...
end function rhyme_report_plot_histograms_test
