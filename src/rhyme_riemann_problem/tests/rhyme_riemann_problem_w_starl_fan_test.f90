logical function rhyme_riemann_problem_w_starl_fan_test() result(failed)
   ...
   tester = .describe."riemann_problem_w_starL_fan"
...
#define VKDX , hy_factory%v(3)
   ...
   ! x-direction
   u = riemann_problem_w_starL_fan(sol, 1)
...
#if NDIM > 1
   ! y-direction
   u = riemann_problem_w_starL_fan(sol, 2)
...
#if NDIM > 2
   ! z-direction
   u = riemann_problem_w_starL_fan(sol, 3)
...
end function rhyme_riemann_problem_w_starl_fan_test
