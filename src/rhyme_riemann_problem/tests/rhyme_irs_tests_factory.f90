module rhyme_riemann_problem_tests_factory
...
contains
   ...
   subroutine rhyme_riemann_problem_Sod_test(l, r, solution)
      implicit none
   ...
   end subroutine rhyme_riemann_problem_Sod_test
   ...
   subroutine rhyme_riemann_problem_123_test(l, r, solution)
      implicit none
   ...
   end subroutine rhyme_riemann_problem_left_blast_wave_test

   !> right half of the blast wave problem of Woodward and Colella
   !! a left shock, a contact and a right rarefaction (very severe)
   subroutine rhyme_riemann_problem_right_blast_wave_test(l, r, solution)
      implicit none
   ...
   end subroutine rhyme_riemann_problem_right_blast_wave_test
   ...
   subroutine rhyme_riemann_problem_two_shocks_collision_test(l, r, solution)
      implicit none
   ...
   end subroutine rhyme_riemann_problem_two_shocks_collision_test

   subroutine rhyme_riemann_problem_factory_set_sides(l, r, s)
      implicit none
   ...
   end subroutine rhyme_riemann_problem_factory_set_sides
end module rhyme_riemann_problem_tests_factory
