logical function rhyme_riemann_problem_test () result (failed)
  ...
  solution%star%left%fan%u = u
  solution%star%left%fan%v = v
  solution%star%left%fan%w = w
  ...
  solution%star%left%shock%u = u
  solution%star%left%shock%v = v
  solution%star%left%shock%w = w
  solution%star%left%shock%speed = speed


  solution%star%right%is_shock = .true.
  solution%star%right%shock%rho = rho
  solution%star%right%shock%u = u
  solution%star%right%shock%v = v
  solution%star%right%shock%w = w
  solution%star%right%shock%speed = speed

  solution%star%right%is_shock = .false.
  solution%star%right%fan%rho = rho
  solution%star%right%fan%u = u
  solution%star%right%fan%v = v
  solution%star%right%fan%w = w
