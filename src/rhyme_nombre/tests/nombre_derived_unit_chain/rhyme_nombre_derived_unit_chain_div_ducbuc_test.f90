logical function rhyme_nombre_derived_unit_chain_div_ducbuc_test () result ( failed )
  ...
  type ( nombre_derived_unit_t ), pointer :: duc, ducbuc
...
end function rhyme_nombre_derived_unit_chain_div_ducbuc_test
