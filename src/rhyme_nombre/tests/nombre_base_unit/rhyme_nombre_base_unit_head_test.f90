logical function rhyme_nombre_base_unit_head_test () result ( failed )
  ...
  head => rhyme_nombre_base_unit_head( units )
  call tester%expect( head == kilogram .toBe. .true. )

  head => rhyme_nombre_base_unit_head( units%next )
  call tester%expect( head == kilogram .toBe. .true. )

  head => rhyme_nombre_base_unit_head( units%next%next )
  call tester%expect( head == kilogram .toBe. .true. )

  failed = tester%failed()
end function rhyme_nombre_base_unit_head_test
