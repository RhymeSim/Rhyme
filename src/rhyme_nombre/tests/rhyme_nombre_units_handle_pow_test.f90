logical function rhyme_nombre_units_handle_pow_test () result (failed)
  ...
  call rhyme_nombre_units_handle_pow( u, 2.0 )
  u => nombre_unit_head(u)
...
end function rhyme_nombre_units_handle_pow_test
