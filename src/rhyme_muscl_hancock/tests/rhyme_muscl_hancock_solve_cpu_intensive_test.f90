logical function rhyme_muscl_hancock_solve_cpu_intensive_test () result ( failed )
  ...
  call rhyme_muscl_hancock_advection_test( &
    rhyme_muscl_hancock_solve_cpu_intensive, mhws, hyid%x, mh_tester )
  call rhyme_muscl_hancock_advection_test( &
    rhyme_muscl_hancock_solve_cpu_intensive, mhws, hyid%y, mh_tester )
  call rhyme_muscl_hancock_advection_test( &
    rhyme_muscl_hancock_solve_cpu_intensive, mhws, hyid%z, mh_tester )
