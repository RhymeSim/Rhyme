logical function rhyme_periodic_table_init_test() result(failed)
   ...
   call tester%expect(pt%species(1)%atomic_weight.toBe.1.00811e0.hint.'H weight')
   ...
   call tester%expect(pt%species(2)%atomic_weight.toBe.1.00811e0.hint.'H weight')
   ...
   call tester%expect(pt%species(3)%atomic_weight.toBe.4.002602e0.hint.'He weight')
   ...
   call tester%expect(pt%species(4)%atomic_weight.toBe.4.002602e0.hint.'He weight')
   ...
   call tester%expect(pt%species(5)%atomic_weight.toBe.4.002602d0.hint.'He weight')
