logical function rhyme_physics_init_test () result ( failed )
  ...
  call ph_tester%expect( physics%kb%u .unitEqualsTo. ph_factory%kb_unit .toBe. .true. .hint. 'Boltzmann' )
  call ph_tester%expect( physics%r%u .unitEqualsTo. ph_factory%r_unit .toBe. .true. .hint. 'R' )
  call ph_tester%expect( physics%amu%u .unitEqualsTo. ph_factory%amu_unit .toBe. .true. .hint. '1 amu' )
