...
file(
  ...
  *_test.f90)
file(
  GLOB_RECURSE factory_files
  RELATIVE ${PROJECT_SOURCE_DIR}
  *_factory.f90)
file(
  GLOB_RECURSE assertion_files
  RELATIVE ${PROJECT_SOURCE_DIR}
  *_assertion.f90)
...
foreach(factory ${factories})
  ...
  if(NOT TARGET ${factory})
    add_subdirectory(${rhyme_src_dir}/${factory} ${CMAKE_BINARY_DIR}/${factory})
  endif()
endforeach(factory)
...
add_library(${PROJECT_NAME}_lib STATIC ${test_files} ${factory_files}
                                       ${assertion_files})
add_dependencies(${PROJECT_NAME}_lib ${test_subject} ${test_deps} ${factories}
                 ${assertions})

# Create the test runner
add_executable(${PROJECT_NAME} test_runner.c)
target_link_libraries(
  ${PROJECT_NAME} PRIVATE ${PROJECT_NAME}_lib ${test_subject} ${factories}
                          ${test_deps})
...
while(${len} GREATER ${idx})
  ...
  add_test(NAME ${test_file} COMMAND $<TARGET_FILE:${PROJECT_NAME}>
                                     ${test_filename})
